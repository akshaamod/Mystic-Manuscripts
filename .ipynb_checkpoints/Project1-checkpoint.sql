...
-- Q12 Altering table to set boolean values to bool data type 
...
-- Q13 Altering purchase date to set data type to timestamp
...
--Q14 Setting capitalisation correctly
UPDATE student.ctt_p1_datadynamo 
SET
